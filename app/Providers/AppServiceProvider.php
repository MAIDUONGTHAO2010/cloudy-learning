...
use App\Repositories\LessonProgressRepositoryEloquent;
use App\Repositories\LessonRepositoryEloquent;
use App\Repositories\NotificationRepositoryEloquent;
use App\Repositories\QuizAttemptRepositoryEloquent;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(LessonProgressRepositoryInterface::class, LessonProgressRepositoryEloquent::class);
        $this->app->bind(QuizRepositoryInterface::class, QuizRepositoryEloquent::class);
        $this->app->bind(QuizAttemptRepositoryInterface::class, QuizAttemptRepositoryEloquent::class);
